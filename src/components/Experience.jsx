      ...
      />
        <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-2'>
          <Details
            ...
            company="Ingelt Pvt Ltd"
            companyLink="https://ingelt.com"
            time="December,2022 - Feburary,2023"
            address="Ghaziabad, Uttar Pradesh"
            work="Worked as a UI/UX Developer, where I collaborated with a team on multiple projects, playing an active role in the design of visually appealing websites."
          />
        </ul>
      </div>
    </div>
